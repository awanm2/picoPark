/******************************************************************************
SparkFun_Alphanumeric_Display_Pico.h
SparkFun Alphanumeric Display Library Raspberry Pico Header File
Priyanka Makin @ SparkFun Electronics
Original Creation Date: July 25, 2019

This file is PICO adaptiation of 

Orignal code is from.
...
Development environment specifics:
	IDE: Arduino 1.8.9 -- Update it to Pico
...
#define ALPHANUMERIC_ADDRESS_71 0x71
#define ALPHANUMERIC_ADDRESS_72 0x72
#define ALPHANUMERIC_ADDRESS_73 0x73
...
private:
	...
	i2c_inst_t* i2c = NULL; // Which i2c we are using
...
public:
    ...
    bool begin(uint8_t addressDisplayOne = DEFAULT_ADDRESS,
               ...
               i2c_inst_t* i2c = NULL
               ); // Sets the address of the device and opens the Wire port for communication
    
    
    // Functions to check if device is connceted
    bool isI2CdevicePresent(int addr);
 ...
 */ 
    ...
    bool writeDataRam(uint8_t displayNumber);
    bool writeCommand(uint8_t address, uint8_t reg);
